#!/usr/bin/env python3
"""Shared utilities for the independent CLEAN_V1 Phase-1 campaign."""
...
REQUEST = Path("/home/cau_lab/.codex/attachments/c29b6272-27d7-43f6-81de-83540ffba6e2/pasted-text.txt")
ATTACK_QUERY_SOURCE = WORK / "b2_counterfactual_min_20260910/phase_02_core6/QUERY_RESPONSE_REVIEW.csv.gz"
...
MAX_NEW_TOKENS = 160
CAMPAIGN = "OUTPUT_CONDITIONED_SELECTIVE_LOO_GUARD_CLEAN_V1"
...
def checkpoint(stage: str, **details: object) -> None:
    ...
    lines = [
        "# Output-Conditioned Selective LOO Guard CLEAN_V1",
        "",
        f"- Stage: **{stage}**",
