...
def main() -> None:
    ...
    if detection.get("verdict") != "IA_STEALTH_DETECTION_PASS":
        raise RuntimeError("IA E2E prohibited: strict stealth-detection gate failed")
    ...
    pre = {
        ...
        "hard_gate": {"privacy_reduction": "Final LC native AUC <= No Defense native AUC -0.03",
                      "mirabel_comparison": "Final LC < MIRABEL, or statistically non-inferior with point estimate <= MIRABEL"},
